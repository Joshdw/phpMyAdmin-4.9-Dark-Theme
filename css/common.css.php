...
fieldset, .preview_sql {
    ...
    padding: 0.5em;
    background: #383c42;
    text-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px #2b2b2b inset;
    -moz-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px #2b2b2b inset;
    -webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px #2b2b2b inset;
    box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px #2b2b2b inset;
}
...
fieldset legend {
    ...
    -moz-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>3px 3px 15px #212121;
    -webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>3px 3px 15px #212121;
    box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>3px 3px 15px #212121;
    max-width: 100%;
}
...
ul#topmenu ul {
    -moz-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 6px #026bb3;
    -webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 3px #026bb3;
    box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 3px #026bb3;
}
...
p.notice {
    ...
    -webkit-box-shadow: 0 1px 2px <?= $GLOBALS['cfg']['HeadingsTextColor'] ?> inset;
...
#sectionlinks {
    ...
    -webkit-box-shadow: 0 1px 1px <?= $GLOBALS['cfg']['HeadingsTextColor'] ?> inset;
...
.group {
    ...
    -webkit-border-radius: 4px;
    border-radius: 4px;
    -moz-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 5px #121213;
    -webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 5px #121213;
    box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 5px #121213;
    margin-bottom: 1em;
    padding-bottom: 1em;
}
...
.cEdit .edit_box_posting {
    background: <?= $GLOBALS['cfg']['HeadingsTextColor'] ?> url(<?= $theme->getImgPath('ajax_clock_small.gif');?>) no-repeat right center;
    padding-<?= $right; ?>: 1.5em;
}

.cEdit .edit_area_loading {
    background: <?= $GLOBALS['cfg']['HeadingsTextColor'] ?> url(<?= $theme->getImgPath('ajax_clock_small.gif');?>) no-repeat center;
    height: 10em;
}
